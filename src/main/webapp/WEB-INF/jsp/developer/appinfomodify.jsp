...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="/dev/modifyAppMsgSave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="softwareName" class="form-control col-md-7 col-xs-12" 
               ...
               name="softwareName" value="${info.softwareName}" required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              name="APKName" value="${info.APKName}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="supportROM" class="form-control col-md-7 col-xs-12" 
              	name="supportROM" value="${info.supportROM}" required="required"
              	data-validate-length-range="20" data-validate-words="1" 
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              name="interfaceLanguage" value="${info.interfaceLanguage}"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="softwareSize" name="softwareSize" value="${info.softwareSize}" required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="downloads" name="downloads" value="${info.downloads}" required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="hidden" value="${info.flatformId}" id="fid" />
              <select name="flatformId" id="flatformId" class="form-control" required="required">
                <option value="${info.flatformId}" selected>${info.flatformName}</option>
              </select>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="hidden" value="${info.categoryLevel1}" id="cl1" />
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input type="hidden" value="${info.categoryLevel2}" id="cl2" />
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="hidden" value="${info.categoryLevel3}" id="cl3" />
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input id="statusName" type="text" class="form-control col-md-7 col-xs-12" 
              	name="statusName" value="${info.statusName}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="hidden" id="logoPicPath" name="logoPicPath" value="${info.logoPicPath}"/>
            	<input type="hidden" id="logoLocPath" name="logoLocPath" value="${info.logoLocPath}"/>
