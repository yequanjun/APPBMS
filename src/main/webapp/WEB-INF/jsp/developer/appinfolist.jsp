...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="/dev/applist">
			    ...
			    <ul>
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="softName" name="querySoftwareName" type="text" class="form-control col-md-7 col-xs-12" value="">
							</div>
						</div>
					</li>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="status" name="queryStatus" class="form-control">
									<c:if test="${status != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${status}">
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="flatformId" name="queryFlatformId" class="form-control">
									<c:if test="${flatForm != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${flatForm}">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control">
									<c:if test="${level1 != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="appCategory" items="${level1}">
						...
						<div class="form-group">
							...
							<input type="hidden" name="categorylevel2list" id="categorylevel2list"/>
        						<select name="queryCategoryLevel2" id="queryCategoryLevel2" class="form-control">
        							<c:if test="${level2 != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="appCategory" items="${level2}">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
        						<select name="queryCategoryLevel3" id="queryCategoryLevel3" class="form-control">
        							<c:if test="${level3 != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="appCategory" items="${level3}">
					...
					<li><button type="submit" class="btn btn-primary" id="find"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询 </button></li>
				</ul>
			</form>
		</div>
	</div>
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/dev/addAppInfo" class="btn btn-success btn-sm">新增APP基础信息</a>
							...
							<tbody>
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<td>${appInfo.firstName } -> ${appInfo.secondName } -> ${appInfo.thirdName }</td>
							...
							<ul class="pagination">
								<c:if test="${currentPageNo > 1}">
									...
									<li class="paginate_button ">
										<a href="javascript:page_nav(document.forms[0],${currentPageNo-1});" aria-controls="datatable-responsive" data-dt-idx="1"
										   tabindex="0">上一页</a>
								...
								<c:if test="${currentPageNo < totalPageCount }">
									...
									<li class="paginate_button next">
										<a href="javascript:page_nav(document.forms[0],${totalPageCount});" aria-controls="datatable-responsive" data-dt-idx="7"
										   tabindex="0">最后一页</a>
									</li>
								</c:if>
							</ul>
